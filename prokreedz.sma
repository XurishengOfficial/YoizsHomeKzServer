...
public plugin_init()
{
	...
	register_clcmd("/gc", "GoCheck1")
	register_clcmd("/tp", "GoCheck1")
	...
	kz_register_saycmd("gc", "GoCheck1",0)
	kz_register_saycmd("gocheck", "GoCheck1",0)
	...
	kz_register_saycmd("teleport", "GoCheck1", 0)
	...
	kz_register_saycmd("tp", "GoCheck1",0)
