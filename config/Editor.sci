...
floattan floatsinh floatcosh floattanh floatabs floatatan floatacos floatasin floatatan2 floatmin floatmax floatclamp contain containi replace add format\
formatex vformat vdformat format_args num_to_str str_to_num float_to_str str_to_float equal equali copy copyc setc parse strtok strbreak trim\
strtolower strtoupper ucfirst isdigit isalpha isspace isalnum strcat strfind strcmp is_str_num split remove_filepath replace_all read_dir read_file write_file\
delete_file file_exists rename_file dir_exists file_size fopen fclose fread fread_blocks fread_raw fwrite fwrite_blocks fwrite_raw feof fgets fputs fprintf\
fseek ftell fgetc fputc fungetc filesize rmdir mkdir unlink open_dir next_file close_dir LoadFileForMe fflush get_vaultdata set_vaultdata remove_vaultdata\
vaultdata_exists get_langsnum get_lang register_dictionary lang_exists CreateLangKey GetLangTransKey AddTranslation LookupLangKey message_begin message_end write_byte write_char write_short write_long write_entity write_angle\
write_coord write_string emessage_begin emessage_end ewrite_byte ewrite_char ewrite_short ewrite_long ewrite_entity ewrite_angle ewrite_coord ewrite_string set_msg_block get_msg_block register_message unregister_message get_msg_args\
get_msg_argtype get_msg_arg_int get_msg_arg_float get_msg_arg_string set_msg_arg_int set_msg_arg_float set_msg_arg_string get_msg_origin get_distance get_distance_f velocity_by_aim vector_to_angle angle_vector vector_length vector_distance IVecFVec FVecIVec\
SortIntegers SortFloats SortStrings SortCustom1D SortCustom2D ArrayCreate ArrayClear ArraySize ArrayGetArray ArrayGetCell ArrayGetString ArraySetArray ArraySetCell ArraySetString ArrayPushArray ArrayPushCell ArrayPushString\
ArrayInsertArrayAfter ArrayInsertCellAfter ArrayInsertStringAfter ArrayInsertArrayBefore ArrayInsertCellBefore ArrayInsertStringBefore ArraySwap ArrayDeleteItem ArrayGetStringHandle ArrayDestroy ArraySort TrieCreate TrieClear TrieSetCell TrieSetString TrieSetArray TrieGetCell\
TrieGetString TrieGetArray TrieDeleteKey TrieKeyExists TrieDestroy menu_create menu_makecallback menu_additem menu_pages menu_items menu_display menu_find_id menu_item_getinfo menu_item_setname menu_item_setcmd menu_item_setcall menu_destroy\
player_menu_info menu_addblank menu_addtext menu_setprop menu_cancel plugin_init plugin_pause plugin_unpause server_changelevel plugin_cfg plugin_end plugin_log plugin_precache client_infochanged client_connect client_authorized client_disconnect\
client_command client_putinserver register_plugin precache_model precache_sound precache_generic set_user_info get_user_info set_localinfo get_localinfo show_motd client_print engclient_print console_print console_cmd register_event register_logevent\
set_hudmessage show_hudmessage show_menu read_data read_datanum read_logdata read_logargc read_logargv parse_loguser server_print is_map_valid is_user_bot is_user_hltv is_user_connected is_user_connecting is_user_alive is_dedicated_server\
is_linux_server is_jit_enabled get_amxx_verstring get_user_attacker get_user_aiming get_user_frags get_user_armor get_user_deaths get_user_health get_user_index get_user_ip user_has_weapon get_user_weapon get_user_ammo num_to_word get_user_team get_user_time\
get_user_ping get_user_origin get_user_weapons get_weaponname get_user_name get_user_authid get_user_userid user_slap user_kill log_amx log_message log_to_file get_playersnum get_players read_argv read_args read_argc\
read_flags get_flags find_player remove_quotes client_cmd engclient_cmd server_cmd set_cvar_string cvar_exists remove_cvar_flags set_cvar_flags get_cvar_flags set_cvar_float get_cvar_float get_cvar_num set_cvar_num get_cvar_string\
get_mapname get_timeleft get_gametime get_maxplayers get_modname get_time format_time get_systime parse_time set_task remove_task change_task task_exists set_user_flags get_user_flags remove_user_flags register_clcmd\
register_concmd register_srvcmd get_clcmd get_clcmdsnum get_srvcmd get_srvcmdsnum get_concmd get_concmd_plid get_concmdsnum get_plugins_cvarsnum get_plugins_cvar register_menuid register_menucmd get_user_menu server_exec emit_sound register_cvar\
random_float random_num get_user_msgid get_user_msgname xvar_exists get_xvar_id get_xvar_num get_xvar_float set_xvar_num set_xvar_float is_module_loaded get_module get_modulesnum is_plugin_loaded get_plugin get_pluginsnum pause\
unpause callfunc_begin callfunc_begin_i get_func_id callfunc_push_int callfunc_push_float callfunc_push_intrf callfunc_push_floatrf callfunc_push_str callfunc_push_array callfunc_end inconsistent_file force_unmodified md5 md5_file plugin_flags plugin_modules\
require_module is_amd64_server find_plugin_byfile plugin_natives register_native register_library log_error param_convert get_string set_string get_param get_param_f get_param_byref get_float_byref set_param_byref set_float_byref get_array\
get_array_f set_array set_array_f query_client_cvar set_error_filter dbg_trace_begin dbg_trace_next dbg_trace_info dbg_fmt_error set_native_filter set_module_filter abort module_exists LibraryExists next_hudchannel CreateHudSyncObj ShowSyncHudMsg\
ClearSyncHud int3 set_fail_state get_var_addr get_addr_val set_addr_val CreateMultiForward CreateMultiForwardEx CreateOneForward PrepareArray ExecuteForward DestroyForward get_cvar_pointer get_pcvar_flags set_pcvar_flags get_pcvar_num set_pcvar_num\
get_pcvar_float set_pcvar_float get_pcvar_string set_pcvar_string arrayset get_weaponid admins_push admins_num admins_lookup admins_flush dod_make_deathmsg user_silentkill make_deathmsg is_user_admin cmd_access access cmd_target\
show_activity show_activity_id show_activity_key colored_menus cstrike_running is_running get_basedir get_configsdir get_datadir register_menu get_customdir AddMenuItem AddClientMenuItem AddMenuItem_call constraint_offset has_flag has_all_flags\
plugin_init plugin_cfg MapLoaded client_authorized client_disconnect setVisibleSlots
