...
{ 
	...
	log_amx("[Precache X.amxx]: Model Precache Reserved Slots: %i", 512 - ArraySize( ArModel ) );
	server_print( "Precache X System: Sound Precache Reserved Slots: %i", 512 - ArraySize( ArSound ) );
	log_amx("[Precache X.amxx]: Sound Precache Reserved Slots: %i", 512 - ArraySize( ArSound ) );
}
